...
def solving_a_quadratic_equation(): # Главное меню > Решение квадратного уравнения (ax²+bx+c=0)
    ...
    while True:
        try:
            ...
            print()
            print('Ошибка! Какой-то коэффициент не является числом! Введите, пожалуйста, ещё раз числа!')
            ...
            if not coefficient_a and coefficient_b != 0 and coefficient_c != 0: # Главное меню > Решение квадратного уравнения (ax²+bx+c=0) > bx+c=0 | a = 0
                ...
                # coef_b_sol_1 = f'{coefficient_b}x'
                # coef_b_sol_2 = 'x' if coefficient_b > 0 else '-x'
                ...
                #     print(f'              {coef_b_sol_1} = {coef_c_sol_2}')
                #     print(f'              x = {coef_c_sol_2}/{coefficient_b}')
                ...
                #     print('   ───────────────────────────────────')
                #     print(f'   Дано:      {coef_b_str}{coef_c_str} = 0')
                #     print(f'   Решение:   {coef_b_sol_2} + {coefficient_c} = 0')
                #     print(f'              {coef_b_sol_2} = -{coefficient_c}')
...
def documentation(): # Главное меню > Справка > Документация
    clear()
    print()
    print('   ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────   ')
    print('         Опция: Справка > Документация                                                                                 ')
    print('   ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────   ')
    print()
    print()
    while True:
...
def program_structure():# Главное меню > Справка > Структура программы
    ...
    print('          ├── Разложение квадратного уравнения (ax²+bx+c=0)                                              [UInit]       ')
    print('          ├── Терминал                                                                                   [UInit]       ')
    print('          ├── Справка                                                                                    [UInit]       ')
    print('          │   ├── Документация                                                                           [UInit]       ')
